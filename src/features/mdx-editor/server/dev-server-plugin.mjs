...
import { applyOp } from '../core/apply-op.mjs';
import { locateBlock, CARD_KINDS } from '../core/locate-block.mjs';
import { parseFile, stripFrontmatter, detectEol, linesText, lineOffsets } from '../core/parse.mjs';

const mdxPlugin = remarkMdx.remarkMdx ?? remarkMdx.default ?? remarkMdx;

/** 项目根探测（候选 cwd / 各级上级目录探测） */
