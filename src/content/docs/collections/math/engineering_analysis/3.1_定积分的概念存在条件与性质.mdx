...
（定积分） 设函数 f 是定义在区间 $[a, b]$ 上的有界函数，在区间 $(a, b)$ 内任意插入 n-1 个分点
...
![](images/756e3f95a192e0de09e719572d3fef6158473d3b6c3bd73b35f8d117b44ed80e.jpg)
...
![](images/d6dc2ac253dd946c2cf70f65eafc918ec211d35efdd00a19bf031a74a1cdde5b.jpg)
...
（可积的充要条件）设函数 $f$ 在区间 $[a, b]$ 上有界，则 $f$ 在 $[a, b]$ 上可积的充要条件是： $\forall \varepsilon > 0, \exists \varepsilon > 0$ ，当 $d < \delta$ 时，
...
（线性性质）设 $f,g\in \mathcal{R}[a,b],\alpha ,\beta \in \mathbf{R}$ ，则 $\alpha f + \beta g\in \mathcal{R}[a,b]$ ，并且
...
（单调性）设 $f, g \in \mathcal{R}[a, b]$ ，且 $f(x) \leqslant g(x), \forall x \in [a, b]$ ，则
...
（对区间的可加性） 设 I 是一个有限闭区间, $a, b, c \in I$ . 若 f 在 I 上可积, 则 f 在 I 的任一闭子区间都可积, 且
...
<Knowledge title="性质 1.5">
（乘积性质） 设 $f, g \in \mathcal{R}[a, b]$ ，则 $fg \in \mathcal{R}[a, b]$ .
</Knowledge>

<Knowledge title="性质 1.6">
（积分中值定理）设 $f\in C[a,b],g\in \mathcal{R}[a,b]$ ，且 $g$ 在 $[a,b]$ 上不变号.则至少存在一点 $\xi \in [a,b]$ ，使注意：由于 $g$ 在 $[a,b]$ 上不变号，
...
![](images/dd80499cbdbc167a961607eaf784fae0022f54970b5f086ab765d8a8e55571fd.jpg)
