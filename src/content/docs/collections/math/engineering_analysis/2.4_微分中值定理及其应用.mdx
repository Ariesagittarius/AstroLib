...
(Fermat 定理) 若函数 $f:(a,b)\rightarrow\mathbf{R}$ 在 $x_{0}\in(a,b)$ 处取得极值,且 f 在
...
（Rolle 定理） 若函数 $f:[a,b]\rightarrow R$ 满足下列条件：
...
![](images/d63133323b316e9110d4afb1a54a3a692426c86392a978decf9aab15200adc62.jpg)
...
(Lagrange 定理) 若函数 $f: [a, b] \rightarrow R$ 满足下列条件：
...
![](images/1948da28cbf1b3c0ad7adeced1a119c4ff1be636ba0637d6b245b3a9c99707db.jpg)
...
![](images/df3d108fa9444915b24ec3e0a4af46372dbc0ff13dbcc23200680c0e04774d8d.jpg)
...
(Cauchy 定理) 设函数 $f, g: [a, b] \rightarrow R$ 满足下列条件：
...
![](images/5d5bd514d4abdfcbb240aa1424985dafe67b6ab0b508c6393e176b3cdbafca48.jpg)
