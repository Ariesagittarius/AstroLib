...
(极值的必要条件) 设 n 元函数 f 在点 $x_{0}$ 可微，且 $x_{0}$ 为 f 的极值点，则必有 $\nabla f(x_{0}) = 0$ .
...
![](images/711327b5013f0070cd9924ea4f23f12f0bce90d3b2850b3afd6cd9161a6bfa06.jpg)  
...
<Example title="例 4.6">
下面的表中“统计数字”一栏是 1971 年到 1990 年各年我国内地总人口数的统计数据。试根据其中 1971 年到 1982 年的统计数据，利用最小二乘法建立我国人口增长的最佳拟合曲线，并预测 1990 年时我国总人口数。
...
![](images/b228dc6599e3755242971f279236c5f2979465382f4ca553cf888ebdae68d5ac.jpg)  

二维码5.4.2多元函数与一元函数极值问题的差异.
...
L _ {x} = 2 z + y + \lambda y z = 0,\tag{①}

$$

$$

L _ {y} = 2 z + x + \lambda x z = 0,\tag{②}

$$

$$

L _ {z} = 2 x + 2 y + \lambda x y = 0,\tag{③}

$$

$$

L _ {\lambda} = x y z - V = 0,\tag{④}
