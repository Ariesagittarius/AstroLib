...
<QRCodeVideo id="6.5.1" url="HTTP://2D.HEP.CN/1254052/24" />
...
$$
M _ {x y} = \int_ {0} ^ {a} K \pi z (a ^ {2} - z ^ {2}) \mathrm{d} z = \frac {K \pi}{4} a ^ {4}. \quad \text {I}
$$
...
$$
I _ {D} = \frac {1}{2} I _ {0} = \frac {m R ^ {2}}{4}. \quad \text {   II   }
$$
