...
<figure class="vp-figure">
  ...
  <figcaption>图7-8 $z = 3x_{1}^{2} + 7x_{2}^{2}$</figcaption>
</figure>

<figure class="vp-figure">
  ![](images/942bbe0424e681fbab615b787b22d295b6020e789b144826d3ce1a6cb94ed04c.jpg)
  <figcaption>图 7-9 $z=3x_{1}^{2}+7x_{2}^{2}$ 和圆柱 $x_{1}^{2}+x_{2}^{2}=1$ 的交线</figcaption>
</figure>
...
定理8 在 7.4 节中和 7.5 节中非常有用，下面的应用仅仅需要定理 6.
<Example title="例 6">
...
<figure class="vp-figure">
  ...
  <figcaption>图 7-10 公共工作计划</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 7-11 最优公共工作计划是（2.1,1.4）</figcaption>
</figure>
</Solution>
</Example>
...
<figure class="vp-figure">
  ...
  <figcaption>图7-12 $Q(\pmb {x})$ 在限制条件 $\pmb{x}^{\mathrm{T}}\pmb {x} = 1$ 下的最大值是4</figcaption>
</figure>
</Block>
