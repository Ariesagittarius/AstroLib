...
解出基本变量 $x_{1}$ 和 $x_{2}$ 得 $x_{1} = \frac{4}{3} x_{3}, x_{2} = 0, x_{3}$ 是自由变量. $Ax = 0$ 的通解有向量形式
...
<figure class="vp-figure">
  ...
  <figcaption>图 1-23 v 加上 p，使 v 平移到 $v + p$</figcaption>
</figure>
图1-24 直线的平移
...
<figure class="vp-figure">
  ...
  <figcaption>图1-25 $Ax = b$ 与 $Ax = 0$ 的解集平行</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图1-26 $Ax = b$ 与 $Ax = 0$ 的解集平行</figcaption>
</figure>
</Knowledge>
...
<figure class="vp-figure">
  ...
  <figcaption>图1-27 通过 $\pmb{p}$ 与 $\pmb{q}$ 的直线</figcaption>
</figure>
