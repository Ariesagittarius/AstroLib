...
<Knowledge title="定理 3">
给出了一个集合的仿射包的几何解释：由一个集合中的点的所有仿射组合构成的点集是平面．比如，图8-4显示了例2中研究的点．虽然所有 $\pmb{b}_1,\pmb{b}_2$ 和 $\pmb{b}_3$ 的线性组合的集合是 $\mathbb{R}^3$ 但所有仿射组合的集合只是穿过 $b_{1},b_{2}$ 和 $b_{3}$ 的平面．注意 $\pmb{p}_{2}$ （由例2）在穿过 $\pmb{b}_1,\pmb{b}_2$ 和 $\pmb{b}_3$ 的平面中，而 $\pmb{p}_{1}$ 不在这个平面中．也可参见习题14.
