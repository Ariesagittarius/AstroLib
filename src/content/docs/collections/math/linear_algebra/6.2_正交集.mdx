...
<figure class="vp-figure">
  ...
  <figcaption>图6-11 求 $\alpha$ 使 $y - \hat{y}$ 正交于 $\pmb{u}$</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 6-12 y 在通过原点的直线 L 上的正交投影</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图6-13 一个向量分解为两个投影之和</figcaption>
</figure>
