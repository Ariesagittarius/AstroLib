...
a. $A = \begin{bmatrix} 4 & 0 \\ 0 & 3 \end{bmatrix}$ b. $A = \begin{bmatrix} 3 & -2 \\ -2 & 7 \end{bmatrix}$
...
<Example title="例 1">
（b）中二次型中出现了项 $-4x_{1}x_{2}$ ，这是因为矩阵 A 对角线上出现了元素-2。相反，例 1（a）中涉及的对角矩阵 A 的二次型中没有 $x_{1}x_{2}$ 的交叉乘积项。
</Example>
