...
<Knowledge title="定理 16 柯西-施瓦茨不等式">
图6-35 直角三角形的斜边是最长边
...
<figure class="vp-figure">
  ...
  <figcaption>图 6-36 三角形边的长度</figcaption>
</figure>
</Solution>
</Knowledge>

<Knowledge title="定理 17 三角不等式">
...
<figure class="vp-figure">
  ...
  <figcaption>图6-37 利用 $[a,b]$ 内不同数目的求值点计算 $\| p\|^2$</figcaption>
</figure>
