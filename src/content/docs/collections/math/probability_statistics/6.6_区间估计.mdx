...
<figure class="vp-figure">
  ...
  <figcaption>图6.6.1 $\mu$ 的置信水平为0.90的置信区间</figcaption>
</figure>
对上述样本, $\mu$ 的区间估计为
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.6.2 $\mu$ 的置信水平为 0.50 的置信区间</figcaption>
</figure>
给出如下一个定义.
</Example>
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.6.3 标准正态分布示意图</figcaption>
</figure>
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图6.6.4 $\chi^2$ 分布置信区间示意图</figcaption>
</figure>
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图6.6.5 二次三项式及其根示意图</figcaption>
</figure>
