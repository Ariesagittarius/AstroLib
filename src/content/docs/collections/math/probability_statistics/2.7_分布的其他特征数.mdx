...
<figure class="vp-figure">
  <div class="vp-figure-grid">
    <div class="vp-sub-figure">
      ...
      <span class="vp-sub-caption">(a) 下侧分位数</span>
    </div>
    <div class="vp-sub-figure">
      ![](images/86c5820fdad7322e5204d9b5c0cd716f69e1cde5d2bcff0f292a9c6449987005.jpg)
      <span class="vp-sub-caption">(b) 上侧分位数</span>
    </div>
  </div>
  <figcaption>图2.7.1 分位数与上侧分位数的区别</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图2.7.2 连续随机变量的中位数</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 2.7.3 两个密度函数，(a) 为左偏，(b) 为右偏</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图2.7.4 两个密度函数与标准正态分布密度函数的比较</figcaption>
</figure>
