...
<figure class="vp-figure">
  ...
  <figcaption>图5.2.1 经验分布函数</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图5.2.2 例5.2.2的频数直方图</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 5.2.4 两车间产量的背靠背茎叶图</figcaption>
</figure>

<figure class="vp-figure">
  <figcaption>图 5.2.3 测试成绩的茎叶图</figcaption>
</figure>
...
4. 某公司对其 250 名职工上班所需时间 (单位: $	ext{min}$) 进行了调查, 下面是其不完整的频率分布表:
<table><tr><td>所需时间</td><td>频率</td></tr><tr><td>$0 \sim 10$</td><td>$0.10$</td></tr><tr><td>$10 \sim 20$</td><td>$0.24$</td></tr><tr><td>$20 \sim 30$</td><td></td></tr><tr><td>$30 \sim 40$</td><td>$0.18$</td></tr><tr><td>$40 \sim 50$</td><td>$0.14$</td></tr></table>
(1) 试将频率分布表补充完整；
