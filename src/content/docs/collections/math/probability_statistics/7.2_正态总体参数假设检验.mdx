...
<figure class="vp-figure">
  <div class="vp-figure-grid">
    <div class="vp-sub-figure">
      ...
      <span class="vp-sub-caption">(b) $H_{1}$ : $\mu < \mu_{0}$</span>
    </div>
    <div class="vp-sub-figure">
      ![](images/80dccd9ea4353de307a075248ca696b253f05d673a6421fde10fc6699253d4d4.jpg)
      <span class="vp-sub-caption">(c) $H_{1}$ : $\mu \neq \mu_{0}$</span>
    </div>
  </div>
  <figcaption>图7.2.1 $u$ 检验的拒绝域</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图7.2.2 $g(\mu)$ 的图形</figcaption>
</figure>
