...
W _ {\text { Ⅲ }} = \{\mid u \mid \geqslant c \}.
...
W _ {\text { Ⅲ }} = \left\{\mid u \mid \geqslant u _ {1 - \alpha / 2} \right\}.\tag{7.2.10}
...
p _ {\text {Ⅲ}} = P (| t | \geqslant | t _ {0} |),\tag{7.2.18}
...
p _ {\text {Ⅲ}} = 2 \min \left\{P (\chi^ {2} \geqslant \chi_ {0} ^ {2}), P (\chi^ {2} \leqslant \chi_ {0} ^ {2}) \right\}.\tag{7.2.28}
