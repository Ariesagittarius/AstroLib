...
<figure class="vp-figure">
  ...
  <figcaption>图5.3.3 不同总体样本均值的分布</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图5.3.5 $x_{(k)}$ 取值的示意图</figcaption>
</figure>
...
$$
\begin{array}{r l} p _ {i j} (y, z) & = \frac {n !}{(i - 1) ! (j - i - 1) ! (n - j) !} [ F (y) ] ^ {i - 1} [ F (z) - F (y) ] ^ {j - i - 1}. \\ & [ 1 - F (z) ] ^ {n - j} p (y) p (z), \quad y \leqslant z, \end{array} \tag{5.3.16}
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图5.3.6 $x_{(i)}$ 与 $x_{(j)}$ 取值的示意图</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 5.3.7 月销售量数据的箱线图</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 5.3.8 三种常见的箱线图及其对应的分布轮廓</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图5.3.9 20天生产的某产品的直径的箱线图</figcaption>
</figure>
</Example>
