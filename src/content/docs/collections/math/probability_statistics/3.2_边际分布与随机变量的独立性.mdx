...
<figure class="vp-figure">
  ...
  <figcaption>图3.2.1 $p(x,y)$ 的非零区域</figcaption>
</figure>
<figure class="vp-figure">
  ![](images/4e67565caefb95697efa7a7bfd6bc1f33eec88b907cc62f6226e24ea5848d054.jpg)
  <figcaption>图 3.2.2 X 的边际密度函数( $Be(2,1)$ )</figcaption>
</figure>
当 $0 < y < 1$ 时，有
$$
p _ {Y} (y) = \int_ {- \infty} ^ {\infty} p (x, y) \mathrm{d} x = \int_ {y} ^ {1} \mathrm{d} x = 1 - y.
...
<figure class="vp-figure">
  ...
  <figcaption>图 3.2.3 Y 的边际密度函数(三角形分布)</figcaption>
</figure>
(2) 要求的概率分别为
$$
...
$$
P (X + Y <   1. 2) = \int_ {0} ^ {0. 2} \int_ {0} ^ {1} \mathrm{d} y \mathrm{d} x + \int_ {0. 2} ^ {1} \int_ {0} ^ {1. 2 - x} \mathrm{d} y \mathrm{d} x = 0.68.
$$
(2) 事件 $\{XY<1/4\}$ 的非零区域如图 3.2.4(b) 所示, 其概率为
$$
P (X Y <   1 / 4) = \int_ {0} ^ {1 / 4} \int_ {0} ^ {1} \mathrm{d} y \mathrm{d} x + \int_ {1 / 4} ^ {1} \int_ {0} ^ {1 / 4 x} \mathrm{d} y \mathrm{d} x = 0.5966.
$$
...
<figure class="vp-figure">
  <div class="vp-figure-grid">
    <div class="vp-sub-figure">
      ...
      <span class="vp-sub-caption">(a) $\{x+y<1.2,0<x,y<1\}$</span>
    </div>
    <div class="vp-sub-figure">
      ![](images/3cdbb1a3f86a32400d3f61612a8ad7ccf725ee3c38dccdc9d883c0b3cdd1c420.jpg)
      <span class="vp-sub-caption">(b) $\{xy<\frac{1}{4},0<x,y<1\}$</span>
    </div>
  </div>
  <figcaption>图 3.2.4 $p(x,y)$ 的非零区域与有关事件的交集部分</figcaption>
</figure>
