...
<QRCodeVideo title="非线性波、孤波" url="https://api.guangyiedu.com/v3/resource/resource/r/NewQrCode-XUrfPg7AjyRGJJBpa0fE" />  
...
<figure class="vp-figure">
  ...
  <figcaption>图6.26 驻波的形成</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.27 弦上的驻波振动简图</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.28 矩形膜上的二维驻波(第三行是第一行的立体图)</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图6.29 波阻对反射波相位的影响</figcaption>
</figure>
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.30 弦(或管)振动的几种简正模式</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图6.31 例6.8图</figcaption>
</figure>
$$
