...
<QRCodeVideo title="光程和光程差" url="https://api.guangyiedu.com/v3/resource/resource/r/NewQrCode-T6Fuun1Sjb3oJGp1qYEq" />  
...
<figure class="vp-figure">
  ...
  <figcaption>图 12.9 平行光通过透镜后各光线的光程相等</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图12.10 例12.2图</figcaption>
</figure>
$$
...
$$
r _ {2} - r _ {1} = - (n - 1) d <   0\tag{\textcircled{1}}
$$
与原来零级明纹位置所满足的 $r_2 - r_1 = 0$ 相比可知，在 $\mathrm{S}_2$ 前有介质时，零级明纹应该下移.
$S_{2}$ 处没有介质时第 k 级明纹的位置满足
$$
r _ {2} - r _ {1} = k \lambda (k = 0, \pm 1, \pm 2, \dots)\tag{\textcircled{2}}
$$
