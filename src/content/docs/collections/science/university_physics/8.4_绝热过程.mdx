...
<figure class="vp-figure">
  ...
  <figcaption>图 8.10 绝热线比等温线陡</figcaption>
</figure>
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图8.11 例8.1图</figcaption>
</figure>
...
$a \to b$ 过程的方程为
$$
\frac {p}{V} = \tan \theta (\text { 恒量 })\tag{\textcircled{1}}
$$
