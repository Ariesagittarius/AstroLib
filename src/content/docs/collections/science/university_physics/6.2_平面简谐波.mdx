...
<QRCodeVideo title="平面简谐波的波函数" url="https://api.guangyiedu.com/v3/resource/resource/r/NewQrCode-5eBbIPmeqW1L04MycJMJ" />
...
<figure class="vp-figure">
  ...
  <figcaption>图6.7 波函数的推导</figcaption>
</figure>
$$
y = A \cos \omega \left(t - \frac {x}{u}\right)\tag{6.15}
$$
式(6.15)就是沿x轴正方向传播的平面简谐波的表达式,或称波函数,有时也称波动方程 <sup>①</sup> .
...
<QRCodeVideo title="波函数的物理意义" url="https://api.guangyiedu.com/v3/resource/resource/r/NewQrCode-YwXmJEqIddlqR9LBs5Br" />
根据波函数可知，t 时刻的波形方程为
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图6.10 波形的传播</figcaption>
</figure>
...
<figure class="vp-figure">
  ...
  <figcaption>图 6.11 当波传播时,介质内某体积元的受力和形变</figcaption>
</figure>
式中，G 为剪切模量.
...
<figure class="vp-figure">
  ...
  <figcaption>图6.12 例6.2图</figcaption>
</figure>
此时波函数为
$$
...
<Solution title="解">
（1）由题意知，坐标原点 $O$ 处质点的振动初始条件为： $t = 0$ 时， $y_0 = 0, v_0 > 0$ 。设坐标原点 $O$ 处质点的振动方程为 $y_0 = A\cos (\omega t + \varphi_0)$ ，将初始条件代入，可求出坐标原点处质点的振动初相位 $\varphi_0 = \frac{3}{2}\pi$ ，坐标原点的振动方程为
$$
...
<figure class="vp-figure">
  ...
  <figcaption>图6.13 $t_1 = 0.005\mathrm{s}$ 和 $t_2 = 0.0075\mathrm{s}$ 时的波形图</figcaption>
</figure>
