...
解（1）由题意知 $\omega_0 = 2\pi n = 2\pi \times \frac{1500}{60}\mathrm{rad / s} =$ $50\pi \mathrm{rad / s}$ ，当 $t = 50~s$ 时 $\omega = 0$ ，故由式(1.26）可得
...
解（1）因为 $\mathrm{d}v = a\mathrm{d}t = -kv^2\mathrm{d}t$ 分离变量得
