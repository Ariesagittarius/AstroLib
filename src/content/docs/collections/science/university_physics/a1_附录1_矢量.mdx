...
\mathrm{d} \Phi = \operatorname{grad} \Phi \cdot \mathrm{d} l\tag{Ⅰ.3}
...
\begin{array}{l} \mathrm{d} \Phi = | \text {grad} \Phi | \cos \theta \mathrm{d} l \\ \frac {\mathrm{d} \Phi}{\mathrm{d} l} = | \text {grad} \Phi | \cos \theta \end{array}\tag{Ⅰ.4}
