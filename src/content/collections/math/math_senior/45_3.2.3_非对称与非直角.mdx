...
$$
\left\{ \begin{array}{l l} x _ {1} ^ {2} + y _ {1} ^ {2} = 1 \\ (x _ {1} - x _ {2}) ^ {2} + (y _ {1} - y _ {2}) ^ {2} = 1 6 \\ (x _ {2} - 3) ^ {2} + y _ {2} ^ {2} = 4 \end{array} \right. \Rightarrow \left\{ \begin{array}{l l} x _ {1} ^ {2} + y _ {1} ^ {2} = 1 \\ x _ {1} ^ {2} + y _ {1} ^ {2} - 2 (x _ {1} x _ {2} + y _ {1} y _ {2}) + x _ {2} ^ {2} + y _ {2} ^ {2} = 1 6 \\ x _ {2} ^ {2} + y _ {2} ^ {2} - 6 x _ {2} + 9 = 4 \end{array} \right.\tag{①}
$$
...
$$
\left\{ \begin{array}{l l} x ^ {2} + (y - 1) ^ {2} = 1 6 \\ (x - 3) ^ {2} + y ^ {2} = 4 \end{array} \right. \Rightarrow \left\{ \begin{array}{l l} x ^ {2} + y ^ {2} - 2 y = 1 5 \\ x ^ {2} + y ^ {2} - 6 x = - 5 \end{array} \right.\tag{①}
$$
