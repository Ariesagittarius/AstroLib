...
export const collections: Collection[] = [
  {
    ...
    books: [
      ...
      {
        id: 'linear-algebra-geometry',
        slug: 'linear_algebra_geometry',
        title: '线性代数与几何（第2版）',
        author: '刘吉佑、莫骄 编',
        publisher: '北京邮电大学出版社',
        isbn: '9787563555871',
        ...
        subject: 'math',
        subjectLabel: '数学',
        description: '普通高等教育“十三五”规划教材、北京邮电大学精品教材。系统介绍线性代数与解析几何的基本理论和方法，紧密融合代数运算与几何直观，涵盖行列式、矩阵、向量代数与空间解析几何、线性相关性、线性方程组、特征值与特征向量、二次型及线性空间与线性变换。',
        tags: ['线性代数', '空间解析几何', '行列式', '矩阵', '向量代数', '特征值', '二次型', '线性空间'],
        cover: '/covers/linear_algebra_geometry.jpg',
        entryPoint: '00_内容简介',
        trackClasses: ['.example-card', '.knowledge-card', '.exercise-card', '.fallback-block'],
        modules: {
          '例': { emoji: '✍️', short: '例', aliases: ['例', '例题'], theme: 'chip-example' },
...
export interface FlatBook extends Book {
  collectionId: string;
  collectionSlug: string;
  collectionTitle: string;
}

export function getAllBooks(): FlatBook[] {
  const list: FlatBook[] = [];
