...
// Template: exam | Paper: a4 | Font: 10.5pt
...
#align(center)[
  #v(0.4em)
  #text(font: ("Source Han Serif SC", "SimSun", "STSong", "Songti SC", "Times New Roman"), size: 12pt, weight: "bold")[工科数学分析 课程自测试卷]
  #v(0.2em)
  #text(font: ("Source Han Serif SC", "SimSun", "STSong", "Songti SC", "Times New Roman"), size: 16pt, weight: "bold")[期末模拟自测试卷]
  #v(0.6em)
